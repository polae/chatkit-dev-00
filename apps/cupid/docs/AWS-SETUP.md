# Cupid EC2 Manual Deployment - Command Reference
...
mkdir -p ~/.ssh
mv ~/Desktop/cupid-pk-00.pem ~/.ssh/
chmod 400 ~/.ssh/cupid-pk-00.pem
```
...
```bash
ssh-keygen -t ed25519 -C "your-email@example.com" -f ~/.ssh/github_ec2 -N ""
```
...
Once you complete these steps, your Cupid app will be live on the internet at `http://<YOUR_EC2_IP>`!

For domain and HTTPS setup, see [DOMAIN-SETUP.md](./DOMAIN-SETUP.md).
